    ...
    <article className="rounded-2xl border border-slate-800 bg-slate-900/70 p-5 transition hover:border-slate-700 hover:bg-slate-900 sm:p-6">
      <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex shrink-0 flex-col gap-3 sm:items-end">
          <span className="inline-flex w-fit rounded-full border border-slate-700 px-3 py-1 text-xs font-semibold text-slate-300">
      ...
      {vehicle.notes ? (
        <p className="mt-4 wrap-break-word text-sm leading-6 text-slate-400">
          {vehicle.notes}
        </p>
      ) : null}
    </article>
